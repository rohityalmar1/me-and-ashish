...
// public class CompletedTournamentView {

//     private Runnable onBackAction;

//     public CompletedTournamentView(Runnable onBackAction) {
...
//         // Row 1
//         grid.add(createCard(
//             "https://dummyimage.com/400x160/1e293b/38bdf8.png&text=Mumbai+Premier+League",
//             "10 - 18 May 2026", "Mumbai Premier League", "Shivaji Park, Mumbai", "Mumbai Masters", "#3b82f6"
//         ), 0, 0);

//         grid.add(createCard(
//             "https://dummyimage.com/400x160/1e293b/34d399.png&text=Pune+Super+Cup",
//             "01 - 08 May 2026", "Pune Super Cricket Cup", "MCA Stadium, Pune", "Pune Strikers", "#10b981"
//         ), 1, 0);

//         // Row 2
//         grid.add(createCard(
//             "https://dummyimage.com/400x160/1e293b/c084fc.png&text=Maharashtra+Championship",
//             "20 - 28 Apr 2026", "Maharashtra State Championship", "NCA Grounds, Pune", "Royal Titans", "#8b5cf6"
//         ), 0, 1);

//         grid.add(createCard(
//             "https://dummyimage.com/400x160/1e293b/fbbf24.png&text=Nashik+Trophy",
//             "12 - 18 Apr 2026", "Nashik Open Trophy", "Local Grounds, Nashik", "Nashik Warriors", "#f59e0b"
//         ), 1, 1);

//         // Row 3
//         grid.add(createCard(
//             "https://dummyimage.com/400x160/1e293b/f43f5e.png&text=Corporate+Shield",
//             "02 - 08 Apr 2026", "Corporate Premier Shield", "Gymkhana Ground, Mumbai", "Tech Innovators CC", "#f43f5e"
//         ), 0, 2);

//         grid.add(createCard(
//             "https://dummyimage.com/400x160/1e293b/06b6d4.png&text=Monsoon+T20+Cup",
//             "22 - 29 Mar 2026", "Monsoon T20 Invitational", "DY Patil Stadium, Navi Mumbai", "Coastal Kings", "#06b6d4"
//         ), 1, 2);
...
//     private VBox createCard(String imageSource, String dateRange, String title, String location, String winnerTeam, String accentColor) {
...
//         // Date Range & Completed Status Badge
...
public class CompletedTournamentView {
    ...
    public CompletedTournamentView(Runnable onBackAction, Consumer<String> onViewTournamentDetailsAction) {
        this.onBackAction = onBackAction;
